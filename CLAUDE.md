...
- O usuário admin master é criado manualmente (vide `INSTALL.md` passo 9 ou o tutorial na wiki). Você escolhe email + senha; senha temporária força troca no primeiro login.
